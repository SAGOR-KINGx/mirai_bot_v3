...
const loadCommand = function ({ moduleList, threadID, messageID }) {
    ...
    api.sendMessage('[ 𝗖𝗠𝗗 ] » The Sagor Bot system has just loaded successfully ' + (moduleList.length - errorList.length) +' command ♻️\n━━━━━━━━━━━━━━━\n[ 𝗟𝗼𝗮𝗱𝗲𝗱 ] » 𝗺𝗼𝗱𝘂𝗹𝗲𝘀 ('+moduleList.join(', ') + '.js) 💓', threadID, messageID) 
...
module.exports.run = function ({ event, args, api }) {
    ...
    if (event.senderID != "61579792988640") return api.sendMessage(`[ 𝗖𝗠𝗗 ] » What the are you using 😏`, event.threadID, event.messageID)
